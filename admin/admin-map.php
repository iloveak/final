...
<script>
    ...
    function initMap() {
        var rasayani = {lat: 18.893562,  lng:73.176543};
...
<script async defer
        src="https://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyCkj7qSqi5J58OvKllJyADUkKe_mOH_mXE&callback=initMap">
</script>